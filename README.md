...
In Zenith run `plugins download https://github.com/steve2b2t/PearlPlus/releases/download/2.0.4/PearlPlus-2.0.4.jar` or download the [lastest build](https://github.com/steve2b2t/PearlPlus/releases/latest) and place the jar file in your proxys plugin folder.
