...
In Zenith run `plugins download https://github.com/duccss/PearlPlus/releases/download/2.0.1/PearlPlus-2.0.1.jar` or download the [lastest build](https://github.com/duccss/PearlPlus/releases/latest) and place the jar file in your proxys plugin folder.
